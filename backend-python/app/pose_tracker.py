...
class PoseTracker:
    def __init__(self):
        ...
        self.is_exercise_completed = False  # Track if exercise is completed
        self.is_exercise_skipped = False  # Track if exercise is skipped
...
# ... (imports and init remain the same)
    ...
    def is_exercise_finished(self):
        ...
        return hasattr(self, 'is_exercise_completed') and self.is_exercise_completed
    ...
    def skip_current_exercise(self):
        ...
        self.is_exercise_skipped = True
        return self.skipped_exercise

    def is_exercise_skipped(self):
        """Check if the current exercise was skipped"""
        return hasattr(self, 'is_exercise_skipped') and self.is_exercise_skipped
    ...
    def reset_exercise_state(self):
        ...
        self.is_exercise_skipped = False
    ...
    def load_exercise_dataset(self):
        ...
        # Define paths (same as in ml_utils.py)
        ex_processed = os.path.join(os.path.dirname(__file__), 'data', 'exercises_processed.csv')
        ex_raw = os.path.join(os.path.dirname(__file__), 'data', 'exercises.csv')
    ...
    def evaluate_dataset_sufficiency(self):
        ...
        # Load nutrition data
        nut_processed = os.path.join(os.path.dirname(__file__), 'data', 'nutrition_processed.csv')
        nut_raw = os.path.join(os.path.dirname(__file__), 'data', 'nutrition.csv')
