...
print("[INFO] Preprocessing data for model training...")
...
model = xgb.XGBClassifier(
    ...
    verbosity=0                # PERFORMANCE: Suppress training output for cleaner logs
)
...
print(f"[SUCCESS] Model Training Complete! Accuracy: {acc*100:.2f}%")
...
print("[INFO] Saving trained model and encoders...")
...
joblib.dump(model, os.path.join(models_dir, 'xgb_workout.pkl'))
...
print("")
print("[SUCCESS] AI Model is now ready to provide personalized workout recommendations!")
print("")
