...
import { Activity, Home, Utensils, TrendingUp, Dumbbell, Bot, LogOut, User } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-gray-600 hover:text-[#EF4444] rounded-lg transition-colors"
              title="Logout"
            >
